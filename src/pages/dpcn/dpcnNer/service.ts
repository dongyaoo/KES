...
export async function postDpcnNerForSingleFake(
  body:any,
  options?: { [key: string]: any },
) {
  return request<{ data?: API.EntityArr[] }>('/api/dpcn/nerForSingleFake', {
    method: 'POST',
    data: body,
    ...(options || {}),
  });
}
export async function getDpcnNerForManyFake(options?: { [key: string]: any }) {
  return request<Record<string, any>>('/api/dpcn/nerForManyFake', {
    method: 'GET',
    ...(options || {}),
  });
}